          ...
          <div className="row g-4 justify-content-center">
            {contactInfo.map((info, index) => (
              <div key={index} className="col-lg-4 col-md-6">
                <div
                  className="contact-info-card text-center p-4 h-100 fade-in"
        ...
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-lg-4">
              {/* Office Hours */}
              <div className="contact-sidebar-card p-4 mb-4 fade-in">
                <h5 className="mb-3">
              ...
              {/* Map Placeholder */}
              <div className="contact-sidebar-card p-4 mb-4 fade-in" style={{ animationDelay: '0.1s' }}>
                <h5 className="mb-3">
              ...
              {/* Social Links */}
              <div className="contact-sidebar-card p-4 fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="col-lg-8">
              <div className="accordion" id="faqAccordion">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className={`accordion-item border-0 mb-3 rounded-3 overflow-hidden fade-in`}
