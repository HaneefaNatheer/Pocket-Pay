...
const features = [
  ...
  },
  {
    ...
    title: 'Nearby Jobs',
    description:
      'Find job opportunities close to your campus or home. Save time on commuting and maximize your schedule.',
    color: '#ec4899',
  },
  {
    icon: FaStar,
    ...
    description:
      'Highlight your unique skills and get matched with employers who need exactly what you offer.',
    color: '#f59e0b',
  },
  {
    icon: FaShieldAlt,
    ...
    description:
      'Every employer is verified and reviewed by our team. Work with confidence and safety.',
    color: '#10b981',
  },
];
...
const steps = [
  {
    ...
    description: 'Register and add your skills, availability, and preferences to build your student profile.',
  },
  {
    icon: FaSearchPlus,
    number: '02',
    title: 'Search & Apply',
    description: 'Browse matching jobs, filter by category and location, and apply with one click.',
  },
  {
    icon: FaHandshake,
    number: '03',
    title: 'Get Hired',
    description: 'Interview with employers, negotiate terms, and start your part-time career journey.',
  },
];

const categories = [
  { icon: FaLaptopCode, name: 'Tech', slug: 'tech', color: '#6366f1' },
...
const testimonials = [
  ...
  },
  {
    ...
    avatar: 'EC',
    rating: 5,
    text: 'The verified employers gave me peace of mind. I found a tutoring job that not only pays well but also builds my resume. Highly recommended!',
  },
];
        ...
        <div className="container position-relative">
          <div className="row justify-content-center">
            <div className="col-lg-10 text-center">
              ...
              <p className="hero-subtitle mb-5 slide-up">
                Connect with trusted employers. Build your career while studying.
              </p>
              <form onSubmit={handleSearch} className="hero-search mx-auto slide-up">
              ...
              <div className="hero-tags mt-4 slide-up">
                <span className="text-white-50 me-2">Popular:</span>
                {['Web Developer', 'Tutor', 'Designer', 'Delivery'].map((tag) => (
                  <button
                    key={tag}
                    className="badge bg-white bg-opacity-25 text-white border-0 me-2 mb-2"
          ...
          <div className="row g-4 justify-content-center">
            {stats.map((stat, index) => (
              <div key={index} className="col-md-4">
                <div className="stats-card text-center p-4 fade-in" style={{ animationDelay: `${index * 0.2}s` }}>
      ...
      <section className="features-section py-5">
        <div className="container">
          <div className="text-center mb-5">
            ...
            <h2 className="section-title">Everything You Need to Find<br /><span className="text-gradient">The Right Job</span></h2>
            <p className="section-subtitle">Powerful features designed specifically for students looking for part-time opportunities.</p>
          </div>
          <div className="row g-4">
            {features.map((feature, index) => (
              <div key={index} className="col-lg-3 col-md-6">
                <div className="feature-card h-100 p-4 text-center slide-up" style={{ animationDelay: `${index * 0.15}s` }}>
                  <div className="feature-icon mx-auto mb-4" style={{ backgroundColor: `${feature.color}15` }}>
      ...
      <section className="how-it-works-section py-5">
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="section-subtitle">Get started in three easy steps and land your dream part-time job.</p>
          </div>
          <div className="row g-4 align-items-start">
            {steps.map((step, index) => (
              <div key={index} className="col-lg-4">
                <div className="step-card text-center p-4 slide-up" style={{ animationDelay: `${index * 0.2}s` }}>
      ...
      <section className="categories-section py-5">
        <div className="container">
          <div className="text-center mb-5">
            ...
            <h2 className="section-title">Explore Job <span className="text-gradient">Categories</span></h2>
            <p className="section-subtitle">Find opportunities in the field that matches your skills and interests.</p>
          </div>
          <div className="row g-3 justify-content-center">
            {categories.map((category, index) => (
              <div key={index} className="col-6 col-md-4 col-lg-3">
                <div
                  className="category-card p-4 text-center h-100 fade-in"
      ...
      <section className="testimonials-section py-5">
        <div className="container">
          <div className="text-center mb-5">
            ...
            <h2 className="section-title">What Students <span className="text-gradient">Say</span></h2>
            <p className="section-subtitle">Hear from students who found their perfect part-time jobs.</p>
          </div>
          <div className="row g-4">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="col-lg-4">
                <div className="testimonial-card h-100 p-4 slide-up" style={{ animationDelay: `${index * 0.15}s` }}>
                  <FaQuoteLeft className="quote-icon mb-3" size={24} />
                  ...
                  <div className="testimonial-author d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <small className="text-muted">{testimonial.university}</small>
                    </div>
                  </div>
                </div>
              </div>
