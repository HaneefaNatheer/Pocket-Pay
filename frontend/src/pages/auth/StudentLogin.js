            ...
            <div className="card shadow-lg border-0 rounded-4">
              <div className="card-body p-4 p-md-5">
                <div className="text-center mb-4">
                  ...
                  <h3 className="fw-bold text-dark">Student Login</h3>
                ...
                <div className="text-center">
                  <p className="small text-muted mb-2">
                    Don't have an account? <Link to="/register" className="text-decoration-none fw-semibold">Register as Student</Link>
                  </p>
                  <p className="small text-muted mb-0">
                    Are you an employer? <Link to="/login/employer" className="text-decoration-none fw-semibold">Employer Login</Link>
                  </p>
                </div>
              </div>
            </div>
