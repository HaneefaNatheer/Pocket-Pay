...
const updateProfile = async (req, res) => {
  try {
    ...
    const allowedFields = ['university', 'degree', 'year_of_study', 'address', 'bio', 'preferred_salary_min', 'preferred_salary_max', 'preferred_location', 'date_of_birth', 'latitude', 'longitude'];
    const updates = {};
