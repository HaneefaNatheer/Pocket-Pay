...
const register = async (req, res) => {
  try {
    const { name, email, password, role, phone, company_name, contactPerson, contact_person, companyWebsite, company_website, companyPhone, company_phone, companyAddress, company_address, industry, companyDescription, company_description, businessRegistration, business_registration, university, degree, dateOfBirth, date_of_birth, address, yearOfStudy, year_of_study, nic, permanentAddress, permanent_address, currentAddress, current_address } = req.body;
    ...
    const user = await User.create({
      name: name || contactPerson || contact_person || 'Employer',
      email,
    ...
    if (user.role === 'student') {
      await Student.create({
        user_id: user.id,
        nic: nic || null,
        permanent_address: permanentAddress || permanent_address || null,
        current_address: currentAddress || current_address || null,
        address: permanentAddress || permanent_address || null,
        university: university || null,
        degree: degree || null,
        year_of_study: yearOfStudy || year_of_study || null,
      ...
      await Employer.create({
        user_id: user.id,
        company_name,
        contact_person: contactPerson || contact_person || null,
        company_description: companyDescription || company_description || null,
        business_registration: businessRegistration || business_registration || null,
        company_website: companyWebsite || company_website || null,
        company_phone: companyPhone || company_phone || phone || null,
